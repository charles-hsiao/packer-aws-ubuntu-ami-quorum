...
sudo cp /tmp/node_exporter/etc__default__node_exporter /etc/default/node_exporter
sudo cp /tmp/node_exporter/etc__init.d__node_exporter /etc/init.d/node_exporter
